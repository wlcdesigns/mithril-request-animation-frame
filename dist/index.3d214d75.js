...
const countDown = ()=>{
    ...
    return {
        ...
        view: ()=>[
                _mithrilDefault.default('.number', Math.round(state.count)),
                _mithrilDefault.default('button.stop', {
                    onclick: ()=>stopAnimation()
                }, 'Stop'),
                _mithrilDefault.default('button.start', {
...
document.getElementById("app") && _mithrilDefault.default.mount(document.getElementById('app'), {
    view: (vnode)=>_mithrilDefault.default(countDown)
});
...
},{}]},["iKiqL","bB7Pu"], "bB7Pu", "parcelRequireaf5a")
